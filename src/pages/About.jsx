...
const [selectedIndex, setSelectedIndex] = useState(0);
    ...
    // Embla carousel setup for achievements on mobile
   useEffect(() => {
      if (!emblaApi) return;
     ...
     {/* ── Timeline ── */}
      ...
      <section className="container-narrow py-20 relative overflow-hidden">
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true, amount: 0.05 }}
          className="hidden gap-6 sm:grid-cols-2 xl:grid-cols-4 relative z-10  md:flex"
        >
      ...
      <section className="bg-gradient-temple py-20">
        <div className="container-narrow">
          ...
          <motion.div
            ...
            whileInView="show"
            viewport={{ once: true, amount: 0.05 }}
            className="md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 hidden "
          >
